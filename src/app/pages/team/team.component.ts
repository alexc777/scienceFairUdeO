...
export class TeamComponent {
  arrTeam: any[] = [
    ...
    { image: 'assets/img/KennetRecurso.png', name: 'Kennet Rodriguez', work: 'Frontend Developer', frase: 'Intenta ser mejor en la tarea que eres bueno, y con eso tomaras ventaja.'},
  ]
